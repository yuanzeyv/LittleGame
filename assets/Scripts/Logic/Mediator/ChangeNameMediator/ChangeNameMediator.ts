...
export class ChangeNameMediator extends WindowBaseMediator{  
    RegisterNotification(notificationMap:Map<string,NotificationHandle>):void{
        notificationMap
        .set(NotificationEnum.ChangeNameOpen,this.ChangeNameOpenHandle.bind(this))
    }  

    protected InitPrefabPath(): string {//每个窗口mediator都对应一个窗口预制体
        return "Perfab/ChangeNameLayer/ChangeNameLayer";
    }

    ChangeNameOpenHandle(data:any){  
