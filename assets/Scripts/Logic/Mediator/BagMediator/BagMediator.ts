...
export class BagMeidator extends WindowBaseMediator{  
    RegisterNotification(notificationMap:Map<string,NotificationHandle>):void{
        notificationMap
        .set(NotificationEnum.BagLayerOpen,this.BagLayerOpenHandle.bind(this))
        .set(NotificationEnum.BagLayerClose,this.BagLayerCloseHandle.bind(this))
    }  

    protected InitPrefabPath(): string {//每个窗口mediator都对应一个窗口预制体
        return "Perfab/BagLayer/BagLayer";
    }

    BagLayerOpenHandle(data:any){  
