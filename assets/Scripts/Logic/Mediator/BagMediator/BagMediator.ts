...
export class BagMediator extends WindowBaseMediator{  
    ...
    protected GetWindowParam():WindowParam{
        return {fullScreenBlock:true,canTouchClose:true,bgColor:new Color(125,125,125,125),showLoading:false,windowBlock:false,closeNotice:eNotice.CloseBagLayer}; 
    } 
    ...
    protected OpenLayer(data:any){
        ...
        let canOpen:boolean = _Facade.FindProxy(WindowProxy).OpenMultWindow(this.getMediatorName(),this.mView,this.WindowOrder());//判断组件是否被正常的添加
