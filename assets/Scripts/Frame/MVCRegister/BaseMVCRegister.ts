...
export class BaseMVCRegister implements IBaseMVCRegister {
    ...
    private m_CommandMap: Map<eNotice, CommandConstructor> = new Map<eNotice, CommandConstructor>();
    ...
    protected AllocCommand(commandMap: Map<eNotice, CommandConstructor>) {
    } //注册所需要的中介
    ...
    private RegisterCommand() {//注册所需要的中介
        this.m_CommandMap.forEach((command: CommandConstructor, notify: eNotice) => {
