...
class PhysicsCollider{
   ...
   private InitConfig():void{
       ...
       this.mConfigObject[4] = {"Key":4,"Name":"小杂兵.碰撞器","Type":3,"Desc":"爱做小破坏的一帮坏小子，很是令人讨厌","Shape":1,"Redius":0.2,"Size":{"Width":0.2,"Height":0.2}};
...
export let PhysicsColliderConfig:PhysicsCollider = new PhysicsCollider();